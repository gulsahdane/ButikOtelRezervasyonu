                            ...
                            for (int i = 0; i < odaSayisi; i++)
                            {
                                ...
                                for (int j = 0; j < gunSayisi; j++)
                                {
                                    if (rezervasyonDurumu[i, j] == 0)
                                        ...
                                        Console.Write(" D ");
                                    else if (rezervasyonDurumu[i, j] == 2)
                                        Console.Write(" T ");
                    ...
                    case '3':
                        {
                            ...
                            for (int i = 0; i < odaSayisi; i++)
                            {
                                if (rezervasyonDurumu[i, 1] == 0 && rezervasyonDurumu[i, 0] == 0)
                                {
                                    bosOdaYok = false;
                    ...
                    case '4':
                        {
                            ...
                            for (int i = 0; i < odaSayisi; i++)
                            {
                                ...
                                {
                                    if (rezervasyonDurumu[i, j] == 1 || rezervasyonDurumu[i, j] == 2)
                                    {
                                        odaMusait = false;
                                        break;
                                    }
                                }
                              if (rezervasyonDurumu[i, gun2+1] == 0)
                              {
                                if (odaMusait)
                                {
                                    for (int j = gun1; j <= gun2; j++)
